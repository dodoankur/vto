...
export default function TryOnInterface({ activeTab, setActiveTab }: TryOnInterfaceProps) {
    ...
    <div className="max-w-6xl mx-auto">
      <div className="card">
        ...
        <div className="min-h-[600px]">
          {activeTab === 'upload' ? (
            <UploadTryOn selectedFrame={selectedFrame} />
          ) : (
            <CameraTryOn selectedFrame={selectedFrame} />
          )}
        </div>
      </div>
    </div>
